...
procedure TForm2.SpeedButton1Click(Sender: TObject);
  ...
  begin
   Q.Close;
   q.SQL.Text:='select * from Iznajmljivanja where Datum_iznaj=Film_ID'+edit1.Text;
   q.open;
   uReport.Design('Iznajmljivanja',IznajmljivanjaTbl);
...
begin
  Q.Close;
   q.SQL.Text:='select * from Iznajmljivanja where Datum_iznaj='+edit1.Text;
   q.open;
   uReport.Design('Iznajmljivanja',IznajmljivanjaTbl);
end;
